...
export const Route = createFileRoute("/features")({
  head: () => ({
    meta: [
      { title: "Features — Farm2Food Cycle" },
      {
        name: "description",
        content:
          "Marketplaces, barter trades, planning & forecast, smart search, maps, and the LGU dashboard — every feature explained.",
      },
      { property: "og:title", content: "Farm2Food Cycle features" },
      {
        property: "og:description",
        content: "Features that power Siargao's circular food economy.",
      },
    ],
  }),
...
const features = [
  ...
  {
    icon: Store,
    titleKey: "features.foodWasteMarketplace",
    bodyKey: "features.foodWasteMarketplaceDesc",
  },
  {
    icon: Sprout,
    titleKey: "features.produceMarketplace",
    bodyKey: "features.produceMarketplaceDesc",
  },
  { icon: Handshake, titleKey: "features.barterTrades", bodyKey: "features.barterTradesDesc" },
  {
    icon: TrendingUp,
    titleKey: "features.planningForecast",
    bodyKey: "features.planningForecastDesc",
  },
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <Container className="relative">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-white/90">{t("features.hero.subtitle")}</p>
          </div>
        </Container>
      </section>
