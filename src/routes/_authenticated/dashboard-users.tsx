...
function UserManagement() {
  ...
  const buyers = users.filter(
    (user) => user.primary_role === "resident" || user.primary_role === "local_user",
  ).length;
                ...
                >
                    ...
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      <Badge
                        className={`px-3 py-1 rounded-full text-xs font-semibold ${
                          user.primary_role === "farmer"
                            ? "bg-emerald-100 text-emerald-700 border-emerald-200"
                            : user.primary_role === "restaurant"
                              ? "bg-orange-100 text-orange-700 border-orange-200"
                              : user.primary_role === "resident" ||
                                  user.primary_role === "local_user"
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      size="sm"
                      variant="ghost"
                      className="h-9 w-9 p-0 rounded-full hover:bg-emerald-100 text-slate-600 hover:text-emerald-700"
                    >
                          ...
                          <Badge
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${
                              selectedUser.primary_role === "farmer"
                                ? "bg-emerald-100 text-emerald-700 border-emerald-200"
                                : selectedUser.primary_role === "restaurant"
                                  ? "bg-orange-100 text-orange-700 border-orange-200"
                                  : selectedUser.primary_role === "resident" ||
                                      selectedUser.primary_role === "local_user"
                                    ? "bg-blue-100 text-blue-700 border-blue-200"
                                    : selectedUser.primary_role === "lgu_admin"
                                      ? "bg-purple-100 text-purple-700 border-purple-200"
                                      : "bg-slate-100 text-slate-700 border-slate-200"
                            }`}
                          >
                            ...
                            <div className="relative group">
                              <div className="rounded-xl border border-slate-200 overflow-hidden bg-white shadow-sm hover:shadow-md transition-all duration-200">
                                <img
                                  ...
                                  onClick={() =>
                                    window.open(
                                      selectedUser.government_id_url ?? undefined,
                                      "_blank",
                                    )
                                  }
                                />
