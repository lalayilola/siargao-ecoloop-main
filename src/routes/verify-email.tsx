...
export const Route = createFileRoute("/verify-email")({
  head: () => ({
    meta: [
      { title: "Verify Email — Farm2Food Cycle" },

      {
        name: "description",
        content: "Verify your email address to activate your Farm2Food Cycle account.",
      },
    ],
  }),
...
function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    const verifyEmailFromTokens = async () => {
      const { access_token, refresh_token } = search as {
        access_token?: string;
