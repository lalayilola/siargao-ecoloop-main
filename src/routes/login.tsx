...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign In — Farm2Food Cycle" },
      {
        name: "description",
        content: "Sign in to your Farm2Food Cycle account to access your dashboard.",
      },
    ],
  }),
  component: LoginPage,
        ...
        <Container className="py-12">
          <div className="mx-auto max-w-md text-center mb-8">
            <h1 className="font-display text-4xl font-bold text-white">
              Sign in to Farm2Food Cycle
            </h1>
            <p className="text-white/80 mt-2">
              Access your dashboard to manage your circular food economy activities.
            </p>
          </div>
