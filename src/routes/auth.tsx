...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in or join — Farm2Food Cycle" },

      {
        name: "description",
        content:
          "Create your Farm2Food Cycle account or sign in to post, trade and track your barangay's circular food economy.",
      },
    ],
  }),
...
async function signInOrCreateAccount(email: string, password: string) {
  ...
  const isInvalidCredentials =
    /invalid login credentials|invalid_credentials|invalid_grant|auth\/invalid-credentials/i.test(
      message,
    );
...
function LoginForm() {
  ...
  const handleIdUpload = async () => {
    ...
    try {
      ...
      toast.error(`Failed to upload ID: ${errorMessage}`);
    } finally {
    ...
    <>
          ...
          try {
            ...
            if (!result.ok) {
              if (result.reason === "rate_limit") {
                ...
                toast.error(
                  "Incorrect email or password. If you do not have an account yet, please use Create account.",
                );
      ...
      <Dialog open={showIdUploadModal} onOpenChange={setShowIdUploadModal}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              To participate in marketplace activities, you must upload a valid government-issued ID
          ...
          <div className="space-y-4 py-4">
            ...
            <p className="text-xs text-muted-foreground">
              Note: You will not be able to create listings, buy products, or participate in
              marketplace transactions until your ID is verified by the LGU.
            </p>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={showTermsModal} onOpenChange={setShowTermsModal}>
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-4 text-sm">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                By accessing and using Farm2Food Cycle, you agree to be bound by these Terms and
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Users must provide accurate and complete information during registration. You are
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Farmers, restaurants, and residents must comply with all local regulations regarding
                food safety and waste management. All listings must be accurate and truthful.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Users may not engage in fraudulent activities, misrepresent products, or violate any
                applicable laws. The platform reserves the right to suspend or terminate accounts
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                By using Farm2Food Cycle, you consent to the collection and use of your data as
                described.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Certain activities may require verification by your Local Government Unit. You agree
                to provide valid government-issued identification when requested.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Farm2Food Cycle reserves the right to modify these terms at any time. Continued use of
          ...
          <div className="flex gap-3">
            <Button onClick={handleAcceptTerms} className="flex-1">
              I Accept
            </Button>
      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          <Input
            id="su-brgy"
            required
            placeholder={t("auth.barangayPlaceholder")}
            value={form.barangay}
