  ...
  en: {
    translation: {
      ...
      features: {
        ...
        planningForecastDesc: "Plan future harvests and forecast supply so farmers and buyers can coordinate ahead of time.",
        smartSearch: "Smart Search",
  ...
  tl: {
    translation: {
      ...
      features: {
        ...
        planningForecastDesc: "Magplano ng mga susunod na ani at tantiyahin ang supply para maagang makapag-ugnayan ang mga magsasaka at mamimili.",
        smartSearch: "Smart Search",
  ...
  ceb: {
    translation: {
      ...
      features: {
        ...
        planningForecastDesc: "Pagplano sa umaabot nga ani ug pagbanabana sa supply aron sayo nga makakoordinar ang mga mag-uuma ug pumapalit.",
        smartSearch: "Smart Search",
