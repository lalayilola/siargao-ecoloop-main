      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            <img src={logo} alt="Farm2Food Cycle" className="h-5 w-5 object-contain" />
            <span className="font-display text-base font-semibold text-slate-900">
              Farm2Food Cycle
            </span>
          </div>
          <p className="mt-3 max-w-xs text-sm text-slate-600/80">
            A circular economy platform connecting farmers, restaurants, residents, and LGUs to turn
            waste into harvest.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-600/80">
            ...
            <li>
              <Link to="/trades" className="hover:text-primary hover:font-medium transition-colors">
                Transaction History
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-600/80">
            <li>
              <Link to="/about" className="hover:text-primary hover:font-medium transition-colors">
                About
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/auth" className="hover:text-primary hover:font-medium transition-colors">
                LGU dashboard
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <Link
            to="/auth"
            className="mt-3 inline-flex rounded-full bg-gradient-to-r from-primary to-secondary px-4 py-2 text-sm font-medium text-white shadow-md shadow-primary/10 hover:from-primary/90 hover:to-secondary/90"
          >
            Join Farm2Food Cycle
          </Link>
        </div>
      </div>
      <div className="border-t border-border/60 py-5 text-center text-xs text-slate-600/80">
        © {new Date().getFullYear()} Farm2Food Cycle · Built for a circular economy
      </div>
    </footer>
  );
}
