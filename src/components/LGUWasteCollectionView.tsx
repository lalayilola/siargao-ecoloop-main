...
export function LGUWasteCollectionView() {
  ...
  const handleScheduleCollection = async () => {
    ...
    const payload: WasteCollectionInsert = {
      ...
      hotel_restaurant_id: selectedReport.hotel_restaurant_id,
      hotel_restaurant_name: selectedReport.hotel_restaurant_name,
      ...
      <Dialog open={showScheduleDialog} onOpenChange={setShowScheduleDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Schedule pickup for {selectedReport?.hotel_restaurant_name} - {selectedReport?.waste_type}
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-900">{report.hotel_restaurant_name}</h3>
