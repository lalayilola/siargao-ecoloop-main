...
import { MapPin, Calendar, Scale, ShoppingCart, GitCompareArrows, MessageCircle } from "lucide-react";
        ...
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-full overflow-hidden bg-secondary/10 flex-shrink-0 shadow-md border-2 border-primary/40">
            {item.profiles?.avatar_url ? (
              <img src={item.profiles.avatar_url} alt={item.seller} className="h-full w-full object-cover" />
            ) : (
